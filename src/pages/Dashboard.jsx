...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <div className="bg-gradient-to-br from-blue-800 to-blue-600 px-5 pt-10 pb-8 text-white text-center">
      ...
      <main className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        <div>
          <Link
            to="/setor"
            className="block w-full bg-gradient-to-r from-emerald-600 to-green-500 text-white text-center font-bold text-base py-4 rounded-2xl shadow-lg shadow-green-200 hover:from-emerald-700 hover:to-green-600 transition-all"
          >
            💝 Kirim Dukungan
          </Link>
